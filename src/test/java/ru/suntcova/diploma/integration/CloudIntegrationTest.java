package ru.suntcova.diploma.integration;
...
import ru.suntcova.diploma.dto.PutRequest;
...
import ru.suntcova.diploma.service.StorageService;
...
public class CloudIntegrationTest {
    ...
    void testUploadFileValidData() throws Exception {
        ...
        Optional<ru.suntcova.diploma.entity.File> file = fileRepository.findByFileNameAndUserLogin(FILE_NAME, TEST_LOGIN);
    ...
    void testEditFileNameValidData() throws Exception {
        ...
        Optional<ru.suntcova.diploma.entity.File> file = fileRepository
